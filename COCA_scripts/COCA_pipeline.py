...
def main():
    ...
    # 1. Configuration - MACBOOK PATH
    default_root = "/Users/karan/Desktop/COCA/cocacoronarycalciumandchestcts-2"
    ...
    if choice in ['1', '3']:
        print("\n--- Running Resampler ---")
        # Recommendation for Project 1 & 3 is 0.7 x 0.7 x 3.0 mm
        space = input("Voxel Spacing (mm) [0.7]: ").strip() or "0.7"
        
        # We ensure the target spacing is [x, y, 3.0] to match project goals
        target = [float(space), float(space), 3.0]
